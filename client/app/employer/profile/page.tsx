...
const profileData = {
  name: "Rachel Green",
  email: "rachel@glamoursalon.co.uk",
        ...
        <div className="mb-6 flex items-center gap-5 rounded-3xl border border-k-gray-200 bg-k-white p-6">
          <div className="relative">
            <div className="h-20 w-20 rounded-full bg-gradient-to-br from-k-primary to-k-primary-light flex items-center justify-center">
              <span className="font-serif text-2xl text-white">RG</span>
            </div>
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-k-gray-400 mt-0.5">{profileData.business}</p>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-k-black">{profileData.business}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-k-black">{profileData.location}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-k-black">{profileData.role}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-k-black">{profileData.locations} locations</p>
              </div>
            </div>
          </div>
        </div>
