        ...
        <div className="border-t border-k-gray-200 px-4 py-4">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-full bg-k-primary/10 flex items-center justify-center">
              <span className="text-sm font-semibold text-k-primary">MT</span>
            </div>
            <div>
              <p className="text-sm font-medium text-k-black leading-tight">Maya Thompson</p>
              <p className="text-xs text-k-gray-400">Level 3 Student</p>
            </div>
          </div>
        </div>
      </aside>
